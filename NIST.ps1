...
function Configure-Auditing {
    ...
    $auditMap = @(
        @{ Sc='Account Logon\Credential Validation'; S=$true; F=$true },
        @{ Sc='Account Management\User Account Management'; S=$true; F=$true },
        @{ Sc='Logon/Logoff\Logon'; S=$true; F=$true },
        @{ Sc='Logon/Logoff\Logoff'; S=$true; F=$true },
        @{ Sc='Logon/Logoff\Account Lockout'; S=$true; F=$true },
        @{ Sc='Policy Change\Audit Policy Change'; S=$true; F=$true },
        @{ Sc='Object Access\File Share'; S=$true; F=$true },
        @{ Sc='Detailed Tracking\Process Creation'; S=$true; F=$false }
    )
